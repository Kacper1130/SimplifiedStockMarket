...
class TradeController {
    ...
    public ResponseEntity<?> handeStockOperation(@PathVariable("wallet_id") UUID walletId, @PathVariable("stock_name") String stockName, @RequestBody StockOperation type) {
